...
{* this div is being used to apply special css *}
    ...
    <div class="crm-block crm-content-block crm-report-form-block">
        {*include actions*}
        {include file="CRM/OdooContributionSync/Form/Report/ContributionSync/Actions.tpl"}
...
<script type="text/javascript">
    ...
    function insertSelectAll() {
        var selectAll = cj('<input type="checkbox" onchange="cj(\'input.select_id\').prop(\'checked\', cj(this).is(\':checked\'));" />');
        cj('#ContributionSync table.report-layout thead tr th:first').append(selectAll);
    }
